...
/**
 * @file
 * Contains \Drupal\evanced_aggregator\Entity\EvancedItem.
 */

namespace Drupal\evanced_aggregator\Entity;
 ...
 * @ContentEntityType(
 *   id = "evanced_item",
 *   label = @Translation("Evanced feed item"),
 *   handlers = {
 *     "storage" = "Drupal\evanced_aggregator\EvancedItemStorage",
 ...
 *   },
 *   uri_callback = "Drupal\evanced_aggregator\Entity\Item::buildUri",
 *   base_table = "evanced_aggregator_item",
 *   render_cache = FALSE,
 ...
 * )
 */
class EvancedItem extends ContentEntityBase implements ItemInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['eventtype'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Event Type'))
      ->setDescription(t('Event Type for the item.'))
      ->setDisplayOptions('view', array(
        'type' => 'hidden',
      ))
      ->setDisplayConfigurable('view', TRUE);
  ...
  public function getEventType() {
    return $this->get('eventtype')->value;
  }
  ...
  public function getCacheTagsToInvalidate() {
    return \Drupal\aggregator\Entity\Feed::load($this->getFeedId())->getCacheTags();
  }
